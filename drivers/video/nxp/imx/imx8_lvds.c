...
static int imx8_ldb_soc_setup(struct udevice *dev, sc_pm_clock_rate_t pixel_clock)
{
	...
	pixel_clock = pixel_clock / 2; /* LVDS PHY clock is half of pixel clock */
...
void imx8_ldb_configure(struct udevice *dev)
{
	...
	if (flag & FLAG_COMBO) {
		...
		mode =
			IMX_LVDS_SET_FIELD(LVDS_CTRL_SPLIT_MODE, LVDS_CTRL_SPLIT_MODE__ENABLE) |
			IMX_LVDS_SET_FIELD(LVDS_CTRL_CH0_MODE, LVDS_CTRL_CH0_MODE__DI0) |
			IMX_LVDS_SET_FIELD(LVDS_CTRL_CH0_DATA_WIDTH, LVDS_CTRL_CH0_DATA_WIDTH__24BIT) |
			IMX_LVDS_SET_FIELD(LVDS_CTRL_DI0_DATA_WIDTH, LVDS_CTRL_DI0_DATA_WIDTH__USE_24BIT) |
			IMX_LVDS_SET_FIELD(LVDS_CTRL_DI0_VSYNC_POL, LVDS_CTRL_DI0_VSYNC_POL__ACTIVE_HIGH) |
			IMX_LVDS_SET_FIELD(LVDS_CTRL_CH1_MODE, LVDS_CTRL_CH1_MODE__DI0) |
			IMX_LVDS_SET_FIELD(LVDS_CTRL_CH1_DATA_WIDTH, LVDS_CTRL_CH1_DATA_WIDTH__24BIT) |
			IMX_LVDS_SET_FIELD(LVDS_CTRL_DI1_DATA_WIDTH, LVDS_CTRL_DI1_DATA_WIDTH__USE_24BIT) |
			IMX_LVDS_SET_FIELD(LVDS_CTRL_DI1_VSYNC_POL, LVDS_CTRL_DI1_VSYNC_POL__ACTIVE_HIGH);
		regmap_write(priv->gpr, LDB_PHY_OFFSET + LVDS_CTRL, mode);

		phy_setting =
			LVDS_PHY_CTRL_RFB_MASK |
			LVDS_PHY_CTRL_CH0_EN_MASK |
			LVDS_PHY_CTRL_CH1_EN_MASK |
